...
//		option.addArguments("--headless=old");
	...
	public void select_valid_installer_name_in_production_status_page(String installer) throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[1]/div/div[2]/select")));
		ele = driver
				.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[1]/div/div[2]/select"));
		Select sel = new Select(ele);
		sel.selectByVisibleText(installer);
	}
	...
	public void select_valid_state_in_production_status_page(String status) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[2]/div[1]/div/div[4]/select")));
	...
	public void select_valid_status_in_production_status_page(String status) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[1]/div/div[3]/select")));
		ele = driver
				.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[1]/div/div[3]/select"));
		Select sel = new Select(ele);
		sel.selectByVisibleText(status);
	}
	...
	public void select_valid_production_percentage_in_production_status_page(String productionPercentage) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[2]/div[1]/div/div[2]/select")));
		ele = driver.findElement(
				By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[2]/div[1]/div/div[2]/select"));
		Select sel = new Select(ele);
	...
	public void enter_valid_delta_percentage_in_production_status_page(String percentage) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[2]/div[1]/div/div[3]/input")));
		ele = driver.findElement(
				By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[2]/div[1]/div/div[3]/input"));
	...
	public void enter_valid_customer_name_in_production_status_page(String customerName) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//input[@class='form-control form-control-solid  ps-14'][@placeholder='Customer Name']")));
		ele = driver.findElement(
				By.xpath("//input[@class='form-control form-control-solid  ps-14'][@placeholder='Customer Name']"));
	...
	public void click_the_customer_name_in_the_grid_in_production_status_page() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
				"/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div/div[2]/div[3]/div/table/tbody/tr[1]/td[2]/a/div")));
	...
	public void click_customer_name_arrow_button_in_customer_status() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//i[@class='fa fa-solid fa-caret-down fs-1 show menu-dropdown cursor-pointer pt-1']")));
		ele = driver.findElement(
				By.xpath("//i[@class='fa fa-solid fa-caret-down fs-1 show menu-dropdown cursor-pointer pt-1']"));
		ele.click();
	}
	...
	public void enter_valid_invertor_name_in_invertor_page(String InvertorName) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//input[@class='form-control form-control-solid fs-7  ps-14']")));
