...
public class CGI_Setup {
	...
	public void click_edit_button_in_installer_page() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class='text-hover-primary fs-6  justify-content-center btn-bg-light btn-active-color-primary btn-md cursor-pointer']")));
		ele = driver.findElement(By.xpath("//a[@class='text-hover-primary fs-6  justify-content-center btn-bg-light btn-active-color-primary btn-md cursor-pointer']"));
		ele.click();
	}
	...
	public void upload_valid_profile_photo_in_edit_installer_page() throws InterruptedException, AWTException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//div[@class='col-md-6']")));
	...
	public void click_edit_button_in_investment_details_in_edit_installer_page() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class=' fs-6  justify-content-end btn-bg-light btn-active-color-primary btn-md cursor-pointer']")));
		ele = driver.findElement(By.xpath("//a[@class=' fs-6  justify-content-end btn-bg-light btn-active-color-primary btn-md cursor-pointer']"));
		ele.click();
	}
	...
	public void select_any_checkbox_in_bank_setup_tab() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content_container\"]/div[2]/div/div[1]/table/thead/tr/th[5]/input")));
		ele = driver.findElement(By.xpath("//*[@id=\"kt_content_container\"]/div[2]/div/div[1]/table/thead/tr/th[5]/input"));
		ele.click();
	}
	...
	public void enter_valid_payment_reminder_days_in_email_notification_tab(String PaymentReminder) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@class='form-control form-control-lg form-control-solid mt-2']")));
	...
	public void enter_valid_host_name_in_email_notification_tab(String Hostname) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@class='form-control form-control-lg form-control-solid mt-2'][@title='Enter Host Name. Length is Limited to 50']")));
		ele = driver.findElement(By.xpath("//input[@class='form-control form-control-lg form-control-solid mt-2'][@title='Enter Host Name. Length is Limited to 50']"));
	...
	public void enter_valid_email_address_in_email_notification_tab(String EmailID) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@class='form-control form-control-lg form-control-solid mt-2'][@title='Enter Email Address. Length is Limited to 100']")));
		ele = driver.findElement(By.xpath("//input[@class='form-control form-control-lg form-control-solid mt-2'][@title='Enter Email Address. Length is Limited to 100']"));
	...
	public void enter_valid_password_in_email_notification_tab(String password) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@class='form-control form-control-lg form-control-solid mt-2'][@title='Enter Password. Length is Limited to 100']")));
		ele = driver.findElement(By.xpath("//input[@class='form-control form-control-lg form-control-solid mt-2'][@title='Enter Password. Length is Limited to 100']"));
	...
	public void enter_valid_port_number_in_email_notification_tab(String PortNumber) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@class='form-control form-control-lg form-control-solid mt-2'][@title='Enter Port. Length is Limited to 100']")));
		ele = driver.findElement(By.xpath("//input[@class='form-control form-control-lg form-control-solid mt-2'][@title='Enter Port. Length is Limited to 100']"));
	...
	public void click_investor_button() throws InterruptedException {
		Thread.sleep(2000);
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"#kt_aside_menu\"]/div[6]/div/div[2]/div/span[2]")));
	...
	public void select_the_checkbox_of_the_customer_in_customer_tab() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div[2]/div/table/tbody/tr/td[8]/input")));
		ele = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div[2]/div/table/tbody/tr/td[8]/input"));
		ele.click();
	}
	...
	public void enter_valid_name_in_the_search_box_of_customer_tab(String Name) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@class='form-control form-control-solid  ps-14']")));
	...
	public void click_select_all_check_box_in_customer_tab() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div[2]/div/table/thead/tr/th[8]/input")));
		ele = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div[2]/div/table/thead/tr/th[8]/input"));
		ele.click();
	}
	...
	public void click_one_check_box_in_customer_tab() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div[2]/div/table/tbody/tr[1]/td[8]/input")));
		ele = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div[2]/div/table/tbody/tr[1]/td[8]/input"));
		ele.click();
	}
	...
	public void upload_valid_file_in_the_attachement_field_tab() throws InterruptedException, AWTException {
		Thread.sleep(2000);
		ele = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/form/div/div[2]/div[6]/div[2]/label[2]"));
		JavascriptExecutor js=(JavascriptExecutor)driver;
		js.executeScript("arguments[0].scrollIntoView(true);", ele);
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/form/div/div[2]/div[6]/div[2]/label[2]")));
		ele = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/form/div/div[2]/div[6]/div[2]/label[2]"));
		ele.click();
		// Upload the file
		Thread.sleep(2000);
	...
	public void upload_valid_file_in_add_documents() throws InterruptedException, AWTException {
		Thread.sleep(2000);
		ele = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/form/div/div[3]/div[2]/label[2]"));
		JavascriptExecutor js=(JavascriptExecutor)driver;
		js.executeScript("arguments[0].scrollIntoView(true);", ele);
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/form/div/div[3]/div[2]/label[2]")));
		ele = driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/form/div/div[3]/div[2]/label[2]"));
		ele.click();
		// Upload the file
		Thread.sleep(2000);
	...
	public void click_edit_documents_button_in_edit_investor_page() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class=' fs-6  justify-content-center btn-bg-light btn-active-color-primary btn-md cursor-pointer']")));
		ele = driver.findElement(By.xpath("//a[@class=' fs-6  justify-content-center btn-bg-light btn-active-color-primary btn-md cursor-pointer']"));
		ele.click();
	}
	...
	public void select_valid_checkbox_in_investor_representative_page() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@class='form-check-input'][@name='2065']")));
